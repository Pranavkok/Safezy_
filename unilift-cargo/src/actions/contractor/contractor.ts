...
export const addContractorDetails = async (
  ...
  const contractorDetails = {
    ...
    total_workers: userDetails.noOfWorkers ?? null,
    ...
    other_industries_type: userDetails.industriesServedOther ?? null,
    other_services_type: userDetails.typeOfServicesProvidedOther ?? null,

...
type ActiveCard = 'total' | 'open' | ObservationType;
...
const UaUcNearMissListingSection = () => {
  ...
  const filteredReports = useMemo(() => {
    ...
    if (activeCard === 'open') return reports.filter(r => r.status === 'Open');
    return reports.filter(r => r.observation_type === activeCard);
  }, [reports, activeCard]);

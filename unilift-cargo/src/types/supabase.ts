    ...
    Tables: {
      address: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "address_worksite_id_fkey"
            columns: ["worksite_id"]
            isOneToOne: false
      ...
      cart_reminder_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "cart_reminder_tracking_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      ehs_checklist_done_questions: {
        Row: {
          ...
          created_at: string
          id: number
          is_completed: Database["public"]["Enums"]["checklist_options"]
      ...
      ehs_incident_analysis: {
        Row: {
          ...
          past_incidents_text: string | null
          pre_incident_activity: string | null
          pressure_constraints: Json | null
      ...
      videos: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_incident_analysis"
            columns: ["incident_analysis_id"]
            isOneToOne: false
            referencedRelation: "ehs_incident_analysis"
            referencedColumns: ["id"]
      ...
      worksite: {
        ...
        Relationships: [
          {
            foreignKeyName: "worksite_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
